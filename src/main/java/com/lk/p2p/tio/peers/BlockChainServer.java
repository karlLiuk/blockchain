package com.lk.p2p.tio.peers;

import com.lk.cons.Const;
import com.lk.p2p.tio.handler.BlockChainServerAioHandler;
...
public class BlockChainServer {
     ...
     * 日志对象.
     **/
    private static final Logger LOG = LoggerFactory.getLogger(BlockChainServer.class);

    /**
     * 消息处理.
     **/
    public static BlockChainServerAioHandler aioHandler = new BlockChainServerAioHandler();
